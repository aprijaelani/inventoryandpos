...
class CreateNeracaPengeluaransTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('neraca_pengeluarans', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('neraca_id')->unsigned()->index()->nullable();
            $table->date('date');
            $table->integer('total');
    ...
    {
        Schema::dropIfExists('neraca_pengeluarans');
    }
}
