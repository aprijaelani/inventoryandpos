...
<div class="row">
	<div class="col-md-12">
		<form class="form-horizontal" method="post" action="store">
				{{ csrf_field() }}
			<input type="hidden" name="id_penerimaan" value="{{$penerimaan_barang}}">
					...
					{{-- <table width="100%">	
						...
						<table width="90%" align="center">
							<tr>
								...
								<th width="17%" style="text-align: left;"><button class="btn btn-info btn-block">Simpan</button></th>
								<th width="5%"></th>
							</tr>
						</table>
						</form>
						...
						<div class="col-md-12" align="center">
							<table class="table" width="90%" align="center">
								...
								<tr>
									...
									<td style="text-align: center;"></td>
									<td style="text-align: center;"></td>
									<td style="text-align: center;"><a href=""><i class="fa fa-trash-o"></i></a></td>	
								</tr>
							</table>
						</div>
						<br>
