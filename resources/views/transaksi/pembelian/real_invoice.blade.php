...
<div class="row">
	<div class="col-md-12">
		...
		<form name="form_real_invoice" onsubmit="return validateForm()" action="real_invoice/store" method="post">
			{{ csrf_field() }}
					...
					<div class="panel-heading">
						<div class="row">
							...
							<div class="col-md-6">
								...
								<br>
								<div style="padding: 5px" class="form-group{{ $errors->has('nama') ? 'has-error' : '' }}">
									<label class="col-md-3 col-xm-3">Gudang</label>
									<div class="col-md-5 col-xm-5">   
								...
								<div class="col-md-offset-3 col-md-12">
									...
									<span class="showNotif" style="color: red; text-align:left; display:none" id="showNotifGudang">Gudang Tidak Tersedia</span> 
								</div>
							</div>
						</div>
					</div>
					...
					<div class="panel panel-success">
						<div class="panel-body">
							<div class="col-md-offset-6 col-md-6">
								<div style="padding: 5px" class="form-group{{ $errors->has('nama') ? 'has-error' : '' }}">
									<label class="col-md-3 col-xm-3">Total</label>
								...
								<br>
								<div style="padding: 5px" class="form-group{{ $errors->has('nama') ? 'has-error' : '' }}">
									<label class="col-md-3 col-xm-3">Keterangan</label>
								...
								<br>
								<div style="padding: 5px" class="form-group{{ $errors->has('nama') ? 'has-error' : '' }}">
									<label class="col-md-3 col-xm-3">Pembayaran</label>
									<div class="col-md-6 col-xm-6">    
...
<script>
	...
	function validateForm() {
	    ...
	    var gudang = document.forms["form_real_invoice"]["gudang_id"].value;
