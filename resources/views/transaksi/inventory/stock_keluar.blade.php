...
<div class="row">
	<div class="col-md-12">
		<form class="form-horizontal" name="form_create" onsubmit="return validateForm()" method="post" id="myform" action="stok-keluar/proses">
			{{ csrf_field() }}
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title"><strong>Kurang Stok Manual</strong></h3>
				</div>
...
<script>
  ...
  //       	}
	...
	function validateForm() {
		var bool = false;
	    var tanggal = document.forms["form_create"]["tanggal_check"].value;
	    var gudang = document.forms["form_create"]["gudang_check"].value;
