...
<div class="row">
	<div class="col-md-12">
		<form class="form-horizontal" name="form_create" onsubmit="return validateForm()" method="post" id="myform" action="kas-keluar/proses">
			{{ csrf_field() }}
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">Kas Keluar Toko</h3>
				</div>
    ...
    $(document).ready(function(){
		...
		$(document).on('blur', '.autocomplete', function() {
        	...
        	if (search){
        		...
        		$.ajax({
                    url: '/kas-keluar/biaya_pendapatan',
                    type: "POST",
              		data: {search:search},
                    dataType: "json",
