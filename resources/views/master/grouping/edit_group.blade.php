...
<div class="row">
	<div class="col-md-12">
		<form class="form-horizontal" onsubmit="return validateForm()" name="form_group_edit" method="post" action="update">
				{{ csrf_field() }}
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">Ubah Jenis Barang</h3>
				</div>
				<div class="panel-body">
					<div class="form-group">
						<label class="col-md-4 control-label">Jenis Barang</label>
						<div class="col-md-4">                                            
							<input type="text" value="{{ old('nama') ?: $grouping->nama }}" name="nama" id="nama" class="form-control" placeholder="Jenis Barang"/>
...
<script type="text/javascript">
 ...
 //        	}
	...
	function validateForm() {
		var bool = false;
	    var nama = document.forms["form_group_edit"]["nama"].value;
