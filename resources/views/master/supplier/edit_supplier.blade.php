		...
		<form class="form-horizontal" onsubmit="return validateForm()" name="form_supplier_edit" method="post" action="update">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">Ubah Supplier</h3>
				</div>
				<div class="panel-body">
					<div class="form-group">
						<label class="col-md-4 control-label">Nama Supplier</label>
						<div class="col-md-4">                                            
							<input type="text" value="{{ old('nama') ?: $supplier->nama }}" name="nama" id="nama" class="form-control" placeholder="Nama Supplier"/>
...
<script type="text/javascript">
 ...
 //        	}
	...
	function validateForm() {
		var bool = false;
	    var nama = document.forms["form_supplier_edit"]["nama"].value;
