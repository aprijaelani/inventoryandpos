...
<div class="row">
	<div class="col-md-12">
		<form class="form-horizontal" onsubmit="return validateForm()" name="form_sales_edit" method="post" action="update">
				{{ csrf_field() }}
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">Ubah Sales</h3>
				</div>
				<div class="panel-body">
					<div class="form-group">
						<label class="col-md-4 control-label">Nama Sales</label>
						<div class="col-md-4">                                            
							<input type="text" value="{{ old('nama') ?: $employee->nama }}" name="nama" id="nama" class="form-control" placeholder="Nama Sales"/>
...
<script type="text/javascript">
 ...
 //        	}
	...
	function validateForm() {
		var bool = false;
	    var nama = document.forms["form_sales_edit"]["nama"].value;
