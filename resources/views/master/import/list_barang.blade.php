                ...
                <div class="table-responsive">
                  <table class="table table-striped table-actions">
                    ...
                    <tbody>                                            
                      ...
                      <tr>
                        <td style="text-align: center;">{{$barang->kode_supplier}}</td>
                        <td style="text-align: center;">{{$barang->supplier['nama']}}</td>
                        <td style="text-align: center;">{{$barang->kode_barcode}}</td>
                        <td style="text-align: center;">{{$barang->nama_barang}}</td>
                        <td style="text-align: center;">{{$barang->grouping['nama']}}</td>
                        <td align="center">
