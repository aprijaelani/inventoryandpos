...
<div class="row">
	<div class="col-md-12">
		<form class="form-horizontal" onsubmit="return validateForm()" name="form_gudang_create" method="post" action="create">
				{{ csrf_field() }}
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">Tambah Gudang</h3>
				</div>
				<div class="panel-body">
					<div class="form-group">
						<label class="col-md-4 control-label">Nama Gudang</label>
						<div class="col-md-4">                                            
							<input type="text" name="nama" id="nama" class="form-control" placeholder="Nama Gudang" autofocus />
...
<script type="text/javascript">
 ...
 //        	}
	...
	function validateForm() {
		var bool = false;
	    var nama = document.forms["form_gudang_create"]["nama"].value;
